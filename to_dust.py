...
class_to_adb = {
    ...
    'battle_resource_dust': {'func': game_tap_sleep_X2_ShortInv, 'params': config_positions.battle_resource_dust},
...
class_order = ["menu", "battle_story", "battle_resource_01", "battle_resource_02", "battle_resource_dust", "battle_entry", "battle_confirm", "battle_ongoing", "battle_win"]
